      ...
      <header>
        <div
          className={`${
            headerClass
              ? headerClass
              : "main-header js-main-header auto-hide-header full-width menu-center header--sticky"
          } ${isVisible ? "show-bg" : ""}`}
        >
          <div
            className={`main-header__layout  ${isVisible ? "action" : "top"}`}
          >
            <div className="main-header__inner">
              ...
              <nav
                className={`main-header__nav js-main-header__nav main-header__default ${
                  menuOpen ? "is_mobile main-header__nav--is-visible" : ""
                }`}
                id="main-header-nav"
              ...
              >
                <span>Menu</span>
                <i
                  className="main-header__nav-trigger-icon"
                  aria-hidden="true"
                ></i>
              </button>
            </div>
