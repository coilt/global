        ...
        <div className="ms-page-content">
          <div className="team-area one gallery">
            <div className="container">
              ...
              <h1 className="title">
                Simple Grid 3 col. <br /> Hover Style #1
              </h1>
                    ...
                    <a className="mfp-img" href="#0" title="">
                      <figure className="media-wrapper media-wrapper--4:3">
                        <Image
                          decoding="async"
                          src={blogImg1}
                          alt="full-shot-travel-concept-with-landmarks"
                        />
                      </figure>
                    </a>
                  </div>
                    ...
                    <a className="mfp-img" href="#0">
                      <figure className="media-wrapper media-wrapper--4:3">
                        <Image
                          decoding="async"
                          src={blogImg2}
                          alt="dee-copper-and-wild-XJBC_7VY37k-unsplash"
                        />
                      </figure>
                    </a>
                  </div>
                    ...
                    <a className="mfp-img" href="#0" title="">
                      <figure className="media-wrapper media-wrapper--4:3">
                        <Image
                          decoding="async"
                          src={blogImg3}
                          alt="charming-relaxed-gentle-young-woman"
                        />
                      </figure>
                    </a>
                  </div>
                    ...
                    <a className="mfp-img" href="#0">
                      <figure className="media-wrapper media-wrapper--4:3">
                        <Image
                          decoding="async"
                          src={blogImg4}
                          alt="sebastian-banasiewcz-CMs6ZGOdyho-unsplash"
                        />
                      </figure>
                    </a>
                  </div>
              ...
              <div className="portfolio_wrap">
                <div className="filter grid-masonary ms-masonry-gallery portfolio-feed">
                  ...
                  >
                    <div>
                      <div
                        className="fadein zoom h-align-middle grid-item-p element-item transition creative"
                      ...
                      <div
                        className="fadein zoom center h-align-middle grid-item-p element-item transition design"
                        data-category="transition"
                      >
                        <div className="item--inner">
                          <a href="#0" aria-label="Freezing Birthday">
                    ...
                    <div>
                      ...
                      <div
                        className="fadein zoom center h-align-middle grid-item-p element-item transition style"
                        data-category="transition"
                      >
                        <div className="item--inner">
                          <a href="#0" aria-label="Freezing Birthday">
                      ...
                      <div
                        className="fadein zoom center h-align-middle grid-item-p element-item transition creative photo style"
                        data-category="transition"
                      >
                        <div className="item--inner">
                          <a href="#0" aria-label="Freezing Birthday">
                    ...
                    <div>
                      ...
                      <div
                        className="fadein zoom center h-align-middle grid-item-p element-item transition creative"
                        data-category="transition"
                      >
                        <div className="item--inner">
                          <a href="#0" aria-label="Freezing Birthday">
