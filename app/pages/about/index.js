...
import SingleTeamTwo from "../../src/components/Team/SingleTeamTwo";
          ...
          <div className="banner-area inner">
            <div className="container">
              <h1 className="heading-title">
                ...
                <br /> Forvisually Compelling Stories.​
              </h1>
            </div>
          </div>
                ...
                <div className="top">
                  <div className="row">
                    ...
                    <div className="col-lg-8 col-md-8">
                      <h1 className="title">
                        Authoritatively seize web readiness. Completely
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Completely plagiarize intermandated services whereas
                            multifunctional mindshare. Monotonectally mesh
                            low-risk high-yield methods of empowerment after
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Dynamically maintain reliable e-services without
                            prospective supply chains. Continually deploy
                            cross-unit niches via seamless networks.
                            Synergistically foster ubiquitous methods…
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Appropriately parallel task cutting-edge mindshare
                            rather than B2B catalysts for change. Efficiently
                            myocardinate collaborative niche markets without
                            excellent web-readiness.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Monotonectally parallel task cross-unit e-tailers
                            without performance based platforms.
                            Phosfluorescently unleash market-driven niche
                            markets via flexible functionalities.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="container">
              <div className="team-area-inner">
                ...
                <div className="team-content">
                  ...
                  <h1 className="title">
                    We Have Come <br /> Together to Create
                  </h1>
                </div>
