      ...
      <div className="testimonial-area">
        <div className="container">
          ...
          <h2 className="heading-title">
            Some Reviews From <br /> Clients Abous Us
          </h2>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="testimonial-wraper">
                  <div className="content">
                    Professionally productize customized imperatives and fully
                    tested interfaces. Proactively redefine standardized markets
                    through cross-unit methodologies.{" "}
                  </div>
                  <div className="author">
                    ...
                    <div className="author-details">
                      <h2 className="strokeWidth">John Doe</h2>
