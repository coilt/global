  ...
  return (
    <>
      <div className="ms-sidebar ms-sb-wc ms-sidebar--right">
            ...
            {products
              .map((product, index) => {
                return (
                  <li key={index}>
                    <Link
                      className="ms-widget-product__img"
        ...
        <aside
          id="woocommerce_product_categories-3"
        ...
        >
          ...
          <div className="tagcloud">
            ...
            <a
              href="#0"
              className="tag-cloud-link tag-link-32 tag-link-position-2"
            >
              Move
            </a>
            <a
              href="#0"
              className="tag-cloud-link tag-link-34 tag-link-position-3"
            >
              Sport
            </a>
            <a
              href="#0"
              className="tag-cloud-link tag-link-31 tag-link-position-4"
            >
              Trainers
            </a>
          </div>
