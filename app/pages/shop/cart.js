...
const CartPage = () => {
  const [values, setValues] = useState([
    { id: 1, value: 1, img: productImg1, title: "Run Max 88", price: 120.0 },
    {
      id: 2,
      value: 1,
      img: productImg2,
      title: "Workout Revolution 2",
      price: 180.0,
    },
    { id: 3, value: 1, img: productImg3, title: "	KL 17 BS", price: 80.0 },
    { id: 4, value: 1, img: productImg4, title: "Flex Armour", price: 139.0 },
  ]);
    ...
    <>
      ...
      <main className="ms-main">
        <div className="ms-page-content">
          <article
            id="post-283"
            className="post-283 page type-page status-publish hentry"
          >
                            ...
                            >
                              <div className="ms-quantity">
                                ...
                                <input
                                  ...
                                  min="0"
                                  max="7"
                                  name="cart[26337353b7962f533d78c762373b3318][qty]"
                                  value={item.value}
                                  title="Qty"
                                  placeholder=""
                                  inputmode="numeric"
