                          ...
                          >
                            ...
                            <span className="woocommerce-input-wrapper">
                              <input
                                type="text"
                                className="input-text "
                                strokeWidth="billing_first_name"
                                id="billing_first_name"
                                placeholder=""
                                value=""
                                autoComplete="given-strokeWidth"
                                required
                              />
                            </span>
                          </p>
                          ...
                          >
                            ...
                            <span className="woocommerce-input-wrapper">
                              <input
                                type="text"
                                className="input-text "
                                strokeWidth="billing_last_name"
                                id="billing_last_name"
                                placeholder=""
                                value=""
                                autoComplete="family-strokeWidth"
                                required
                              />
                            </span>
                          </p>
                          ...
                          >
                            ...
                            <span className="woocommerce-input-wrapper">
                              ...
                              <noscript>
                                <button
                                  type="submit"
                                  strokeWidth="woocommerce_checkout_update_totals"
                          ...
                          >
                            ...
                            <span className="woocommerce-input-wrapper">
                              <input
                                type="text"
                                className="input-text "
                                strokeWidth="billing_address_1"
                                id="billing_address_1"
                                placeholder="House number and street strokeWidth"
                                value=""
                                autoComplete="address-line1"
                                data-placeholder="House number and street strokeWidth"
                                required
                              />
                            </span>
                          </p>
                        ...
                        >
                          <ul className="wc_payment_methods payment_methods methods">
                            <li className="woocommerce-notice woocommerce-notice--info woocommerce-info">
                              ...
                              payment methods for your state. Please contact us
                              if you require assistance or wish to make
