                ...
                <div className="row">
                      ...
                      <div className="swiper swiper-container-h1">
                        <Swiper {...sliderOption} className="swiper-wrapper">
                          ...
                          <SwiperSlide className="swiper-slide">
                            <div className="slider-inner">
                              <Image
                                src={`/images/shop/${product.image3}`}
                                width={800}
                                height={600}
                                alt={product.title}
                              />
                          ...
                          <SwiperSlide className="swiper-slide">
                            <div className="slider-inner">
                              <Image
                                src={`/images/shop/${product.image2}`}
                                width={800}
                                height={600}
                                alt={product.title}
                              />
                  ...
                  <div className="col-md-6">
                    <div className="ms-single-product__content">
                      <h2 className="ms-single-product_title">
                        {product.Title}
                      </h2>
                      <p className="price">
                      ...
                      <div className="ms-woocommerce-product-rating woocommerce-product-rating">
                        <div className="ms-rating-icon"></div>
                      ...
                      <div className="woocommerce-product-details__short-description">
                        <p>
                          {product.Description}
                          Phosfluorescently benchmark unique e-services whereas
                          transparent collaboration and idea-sharing.
                          Enthusiastically communicate maintainable networks via
                          global metrics. Credibly negotiate progressive
                          bandwidth for go forward e-commerce. Rapidiously
                          evolve magnetic initiatives through client-based
                          portals.
                        </p>
                      </div>
                      ...
                      >
                        <div className="ms-quantity">
                          <label
                            ...
                            htmlFor="quantity_63ec94c17230a"
                          >
                            Run Max 88 quantity
                          </label>
                          <button
                          ...
                          <input
                            type="number"
                            id="quantity_63ec94c17230a"
                            className="input-text qty text"
                            step="1"
                            min="1"
                            max="7"
                            strokeWidth="quantity"
                            value={value}
                      ...
                      <div className="product_meta">
                        <span className="sku_wrapper">
                          <strong>SKU:</strong>{" "}
                          <span className="sku">161056</span>
                        </span>
                        ...
                        <div className="tab-content">
                          <TabPanel>
                            <div
                              ...
                              tabIndex="0"
                            >
                              Credibly e-enable e-business materials with
                              competitive products. Enthusiastically extend
                              unique leadership before timely users.
                              Synergistically scale B2C e-business rather than
                              quality products. Synergistically incubate
                              extensible outsourcing via magnetic sources.
                              Interactively revolutionize intuitive
